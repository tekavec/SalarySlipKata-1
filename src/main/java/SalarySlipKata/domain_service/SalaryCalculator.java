...
public class SalaryCalculator {
  ...
  public final double getNationInsuranceContributions(double annualSalary) {return (annualSalary - AMOUNT_UP_TO_WHICH_NI_CONTRIBUTION_IS_EXEMPTED) * NI_BASIC_CONTRIBUTIONS_RATE;}
